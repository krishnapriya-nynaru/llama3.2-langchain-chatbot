...
st.title("🤖 ConversAI: Your Intelligent Chat Assistant 🌟")

model = ChatOllama(model="llama3.2:1b", base_url="http://localhost:11434/")

system_message = SystemMessagePromptTemplate.from_template("You are a helpful and friendly AI Assistant.")
